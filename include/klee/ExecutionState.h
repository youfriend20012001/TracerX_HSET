...
namespace klee {
	...
	struct StackFrame {
		...
		std::stack<ref<Expr>*> regionDetailStack;
...
/// @brief ExecutionState representing a path under exploration
	...
	public:
		...
		KInstIterator* pathSpecial;
		int pathSpecialCount;
		int maxSpecialCount;
		TaintSet taint;//lpc Program counter taint

		int* stateTrackingTaint;
		int currentTaintCount;
		int maxCurrentTaint;
		//HSET
		int executionTime;
		int startPCDest;
...
// use on structure
		...
		void pushInsLog(std::string ins);
		void popInsLog();

		bool logCurInstruction(unsigned maxLoop);
